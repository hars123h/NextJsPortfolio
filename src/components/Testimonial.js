          ...
          <div className="total">
            ...
            <div className="left_details">
              <div
                ...
                data-img-url="img/testimonials/Bavo.jfif"
              />
              <div
                className="det_image two wow fadeIn"
                data-wow-duration="1s"
                data-wow-delay="0.2s"
                data-img-url="img/testimonials/jean.jfif"
              />
              <div
                className="det_image three wow fadeIn"
                data-wow-duration="1s"
                data-wow-delay="0.4s"
                data-img-url="img/testimonials/shrey.jpeg"
              />
            ...
            <div className="right_details">
              ...
              <div
                ...
                data-wow-duration="1s"
                data-wow-delay="0.2s"
                data-img-url="img/testimonials/viraj.jpeg"
              />
              <div
                className="det_image three wow fadeIn"
                data-wow-duration="1s"
                data-wow-delay="0.4s"
                data-img-url="img/testimonials/boaz.jfif"
              />
              <span className="circle yellow animPulse" />
